...
| Boundary | Policy Boundary v0 | Active (Phase 1-3 lock) | `_refactor-artifact/02-boundary/policy-boundary-v0.md` |
...
- Continue `_refactor-artifact/05-pos/01_policy-rollout-v0.md` with Phase 4 (integration + reliability).
