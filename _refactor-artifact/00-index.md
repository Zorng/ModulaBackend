...
| Boundary | Menu Boundary v0 | Active (Phase 1-2 lock) | `_refactor-artifact/02-boundary/menu-boundary-v0.md` |
...
- Continue `_refactor-artifact/05-pos/02_menu-rollout-v0.md` with Phase 3 (Commands/queries + access control).
