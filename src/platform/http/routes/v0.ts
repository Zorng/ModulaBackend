...
const v0OfflineSyncModule = bootstrapV0OfflineSyncModule(pool);
const v0SyncModule = bootstrapV0SyncModule(pool);
...
v0Router.use("/offline-sync", v0OfflineSyncModule.router);
v0Router.use("/sync", v0SyncModule.router);
