...
export const V0_CASH_SESSION_ACTION_KEYS = {
  ...
  paidIn: "cashSession.paidIn",
  paidOut: "cashSession.paidOut",
  adjust: "cashSession.adjust",
...
export const V0_CASH_SESSION_IDEMPOTENCY_SCOPE = {
  branchWriteActions: [
    ...
    V0_CASH_SESSION_ACTION_KEYS.paidIn,
    V0_CASH_SESSION_ACTION_KEYS.paidOut,
    V0_CASH_SESSION_ACTION_KEYS.adjust,
